...
**Inference stability**: GPT-5.2 > GPT-4.1 > GPT-5.1. We recommend GPT-5.2 for reproduction, as it yields the most consistent results during our early experiments.
